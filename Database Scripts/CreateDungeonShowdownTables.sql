...
CREATE TABLE `player` (
  ...
  `player_color` varchar(45) DEFAULT '#c23670',
...
CREATE TABLE `card` (
  ...
  `card_defense` decimal(11,2) DEFAULT NULL,
  `card_image_path` varchar(500) DEFAULT NULL,
  `card_description` varchar(500) DEFAULT NULL,
  `card_display_option` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`card_id`),
...
CREATE TABLE `player_card_slot` (
  ...
  KEY `player_card_slot_player_status_id_FK_idx` (`player_status_id`),
  KEY `player_card_slot_slot_id_FK_idx` (`slot_id`),
  KEY `player_card_slot_card_id_FK_idx` (`card_id`),
