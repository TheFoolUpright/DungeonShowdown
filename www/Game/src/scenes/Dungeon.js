...
class Dungeon extends Phaser.Scene {
	...
	loadCardData(data) {
		...
		if (this.slot1Card.isVisible) {
			...
			this.MakeDungeonCardIconsVisible(this.slot1Card, data.card[0])
		}
		else {
		...
		if (this.slot2Card.isVisible) {
			...
			this.MakeDungeonCardIconsVisible(this.slot2Card, data.card[1])
		}
		else {
		...
		if (this.slot3Card.isVisible) {
			...
			this.MakeDungeonCardIconsVisible(this.slot3Card, data.card[2])
		}
		else {
